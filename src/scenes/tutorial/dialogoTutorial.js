...
export default class DialogoTutorial extends Phaser.Scene {
    ...
    create(){
        ...
        const contexto = this.add.text(325, 250, 'Aparece una señora preguntandote que hace una cosa tan bonita en medio de la calle, ofreciendote una loncha de jamón. ¿Qué haces?', {       
