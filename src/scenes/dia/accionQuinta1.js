...
export default class AccionQuinta1 extends Phaser.Scene {
    constructor(){
        super({key: 'accion-quinta-1'})
    ...
    create(){
        ...
        this.character = this.add.image(690, 500, 'ikerEnfadado');
    ...
    confirmarSeleccion() {
        ...
        this.mostrarRecompensa('¡Has conseguido  estar fumado!')
    }
